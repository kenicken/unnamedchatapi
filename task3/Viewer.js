...
//var DEFAULT_URL = 'progress222.pdf';
...
/*
	We create a built-in function that would
    change the default_url base on the request
	of the user. The default_url is changed base
	on what was requested on the server.
